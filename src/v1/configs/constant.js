...
module.exports = {
  ...
  IMG_PATH: {},
  OTP_ALLOW_SEND_TIME: process.env.OTP_ALLOW_SEND_TIME,
  OPT_ALLOW_RESENT_SECOND: process.env.OPT_ALLOW_RESENT_SECOND,
  OTP_EXPIRED_TIME: process.env.OTP_EXPIRED_TIME,
  TOKEN_LIFE_TIME_RESET: process.env.TOKEN_LIFE_TIME_RESET,
  RESET_OTP_LINK: process.env.RESET_OTP_LINK,
